<template>
  <Layout>
    <div class="container-inner mx-auto my-16">
      <section>
        <h2 class="text-4xl font-bold mb-8">Tag: {{ $page.tag.title }}</h2>
      </section>
      <article v-for="post in $page.tag.belongsTo.edges" :key="post.node.id" class="post border-gray-400 border-b mb-12">
