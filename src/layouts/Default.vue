<template>
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen">
    <header class="border-t-14 border-brand-900">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link to="/" class="logo flex items-center">
            ...
            <span class="font-bold m-2">chowson.github.io</span>
          </g-link>
        </div>
        <div class="flex md:hidden">
          <theme-switcher :theme="theme" @themeChanged="updateTheme" class="mr-4 flex items-center" />
          <div class="block">
            <button @click="toggle" class="flex items-center px-3 py-2 border rounded border-gray-500 hover:text-gray-600 hover:border-gray-600" name="Open menu">
              <svg class="current-color h-3 w-3" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Open Menu</title><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z" fill="gray" /></svg>
            </button>
          </div>
        </div>
        <ul
